...
## 2026-02-04 Update (Fallback Unconditional)
- Made fallback unconditional with ultra-low desirability; tightened exile; eased convert/legend/salahudin.
- Monte Carlo: fallback 39.8%, betray 32.2%, exile 21.8%, dead-end 0.
- Multi-variant entropy ~1.84-1.87 (eff ~3.6) with max share ~0.39.
- Verifiers env benchmark_pass: False; env entropy still low due to pathing.
