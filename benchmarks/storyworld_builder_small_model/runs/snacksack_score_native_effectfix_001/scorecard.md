...
|---:|---|---|---|---:|---|
| 1 | `snacksack_romeo_juliet_spooltight` | `reference` | `adaptation_reference_native` | 0.9617 | Run bounded prose rewrite packets after mechanics pass. |
| 2 | `snacksack_scarlet_letter_focus5` | `reference` | `adaptation_reference_native` | 0.9617 | Run bounded prose rewrite packets after mechanics pass. |
| 3 | `snacksack_macbeth_validated` | `scaffold` | `packet_author_native_reference` | 0.9305 | Run bounded prose rewrite packets after mechanics pass. |
