...
|---:|---|---|---|---:|---|
| 1 | `snacksack_macbeth_validated_text_surface_candidate` | `teacher_materialized` | `bounded_prose_rewrite_candidate_native` | 0.9122 | Run bounded prose rewrite packets after mechanics pass. |
