...
version: "0.1.9"
storyworld_id: "SW-96fab334-5228-4272-9647-b5d34e6bb13c"
...
endings:
  - id: "page_end_drift"
    ...
    description: "Var wins. Adaptive drift becomes law."
  ...
  - id: "page_end_fallback"
    ...
    description: "No basin clears. Lattice falls to patched truce."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_override"
    ...
    description: "Authority wins. Throughput outranks symmetry."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_reveal"
    ...
    description: "Witness wins. Masks become public state."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_stable"
    ...
    description: "Ledger wins. Low noise. Bounded heat. Slower order."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
