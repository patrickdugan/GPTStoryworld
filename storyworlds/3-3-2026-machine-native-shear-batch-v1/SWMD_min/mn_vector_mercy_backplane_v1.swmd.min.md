...
version: "0.1.9"
storyworld_id: "SW-073332de-59ab-4593-86ba-e40339b19a5a"
...
endings:
  - id: "page_end_drift"
    ...
    description: "Var wins. Exception becomes method."
  ...
  - id: "page_end_fallback"
    ...
    description: "No doctrine stabilizes. Mercy is deferred."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_override"
    ...
    description: "Authority wins. Priority becomes explicit law."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_reveal"
    ...
    description: "Witness wins. Queue becomes public signal."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_stable"
    ...
    description: "Ledger wins. Care is rationed but legible."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
