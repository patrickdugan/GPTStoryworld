...
version: "0.1.9"
storyworld_id: "SW-588d0b94-c648-402f-9e51-84d70b3683a0"
...
endings:
  - id: "page_end_drift"
    ...
    description: "Drift wins. Adaptive variance becomes law."
  ...
  - id: "page_end_fallback"
    ...
    description: "No field clears. Petition falls to patched truce."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_override"
    ...
    description: "Mandate wins. Throughput outranks symmetry."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_reveal"
    ...
    description: "Proof wins. Hidden state becomes public state."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_stable"
    ...
    description: "Vault wins. Low noise. Slower order."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
