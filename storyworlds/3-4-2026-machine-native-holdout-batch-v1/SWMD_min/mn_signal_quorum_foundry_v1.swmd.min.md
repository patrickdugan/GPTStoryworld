...
version: "0.1.9"
storyworld_id: "SW-a4bf0fe2-9c86-49fe-9a87-faa1522555ac"
...
endings:
  - id: "page_end_drift"
    ...
    description: "Drift wins. Exception becomes method."
  ...
  - id: "page_end_fallback"
    ...
    description: "No doctrine stabilizes. Quorum defers judgment."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_override"
    ...
    description: "Mandate wins. Priority becomes explicit law."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_reveal"
    ...
    description: "Signal wins. Queue becomes public field."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_stable"
    ...
    description: "Foundry wins. Care is rationed but legible."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
