...
version: "0.1.9"
storyworld_id: "SW-d850cbac-3598-4b52-abd6-bf71adbd0722"
...
endings:
  - id: "page_end_drift"
    ...
    description: "Drift wins. Adaptive error becomes governor."
  ...
  - id: "page_end_fallback"
    ...
    description: "No field clears. Docket persists by brittle truce."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_override"
    ...
    description: "Mandate wins. Command outranks consensus."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_reveal"
    ...
    description: "Shard wins. Authority survives by becoming inspectable."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
  ...
  - id: "page_end_stable"
    ...
    description: "Delta wins. Procedure becomes quiet enough to trust."
    expected_critic_score: 0
    proximity_spec:
      - var: "Phase_Clock"
        op: ">="
