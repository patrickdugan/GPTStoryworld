...
def _set_cast(data: Dict[str, Any]) -> Dict[str, Any]:
    cast = [
        {"id": "char_garcin", "name": "Garcin", "description": "A self-justifier trapped in reputation recursion."},
        {"id": "char_inez", "name": "Inez", "description": "A ruthless analyst of hypocrisy and desire."},
        {"id": "char_estelle", "name": "Estelle", "description": "A status-seeking mirror addict in denial loops."},
        {"id": "char_valet", "name": "The Valet", "description": "A procedural custodian of the sealed room's rules."},
    ]
...
def main() -> int:
    ...
    world = build_subset(
        base,
        target_encounters=80,
        title="No Exit: Recursive Gaze Chamber (Interactive Adaptation)",
        about=(
            "A compact inferential chamber where three condemned agents recursively model each other's beliefs, "
            "turning social perception into irreversible punishment."
        ),
        motif=(
            "Hell is other agents: tiny state space, high interpretability, and escalating recursive belief loops under closed-room constraints."
        ),
    )
    ...
    out_path = out_dir / "sartre_no_exit_recursive_belief_modeling_multiending_v1.json"
    ...
    gate_path = report_dir / "sartre_no_exit_recursive_belief_modeling_multiending_v1.gate.json"
    ...
    summary_path = report_dir / "sartre_no_exit_recursive_belief_modeling_multiending_v1.summary.json"
