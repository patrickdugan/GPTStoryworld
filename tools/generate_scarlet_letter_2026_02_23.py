...
def _set_cast(data: Dict[str, Any]) -> Dict[str, Any]:
    cast = [
        {"id": "char_hester", "name": "Hester Prynne", "description": "Publicly shamed but internally coherent; adapts under relentless surveillance."},
        {"id": "char_dimmesdale", "name": "Arthur Dimmesdale", "description": "Saintly minister with escalating private guilt and secrecy burden."},
        {"id": "char_chillingworth", "name": "Roger Chillingworth", "description": "Adversarial inference agent optimizing truth extraction through probes."},
        {"id": "char_community", "name": "Puritan Community", "description": "Distributed moral regulator with noisy, slow-updating consensus judgments."},
        {"id": "char_pearl", "name": "Pearl", "description": "Outlier child acting as truth-signal generator and semantic disruptor."},
    ]
...
def main() -> int:
    ...
    world = build_subset(
        ...
        title="The Scarlet Letter: Moral Surveillance Field (Interactive Adaptation)",
        about=(
            "A closed moral society with slow information diffusion where public signal diverges from private truth, "
            "forcing long-horizon choices under reputation pressure and conscience load."
        ),
        motif=(
            "Reputation-and-conscience simulator: hidden guilt, adversarial probing, symbol drift of the letter, "
            "and decentralized norm enforcement under noisy inference."
        ),
    )
    ...
    out_path = out_dir / "hawthorne_scarlet_letter_reputation_conscience_multiending_v1.json"
    ...
    gate_path = report_dir / "hawthorne_scarlet_letter_reputation_conscience_multiending_v1.gate.json"
    ...
    summary_path = report_dir / "hawthorne_scarlet_letter_reputation_conscience_multiending_v1.summary.json"
