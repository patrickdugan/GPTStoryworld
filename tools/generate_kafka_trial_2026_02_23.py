...
def _set_cast(data: Dict[str, Any]) -> Dict[str, Any]:
    cast = [
        {"id": "char_josef_k", "name": "Josef K.", "description": "A defendant trapped in shifting procedural shadows."},
        {"id": "char_frau_grubach", "name": "Frau Grubach", "description": "A domestic authority filtering social legitimacy."},
        {"id": "char_fraeulein_buerstner", "name": "Fraulein Buerstner", "description": "A witness node with uncertain alignment."},
        {"id": "char_lawyer_huld", "name": "Advocate Huld", "description": "A legal intermediary exploiting opacity and delay."},
        {"id": "char_leni", "name": "Leni", "description": "A seductive guide through obscure institutional channels."},
        {"id": "char_priest", "name": "The Priest", "description": "A cryptic interpreter of law, guilt, and fate."},
    ]
...
def main() -> int:
    ...
    world = build_subset(
        ...
        title="The Trial: Ontological Docket (Interactive Adaptation)",
        about=(
            "An intentionally underspecified legal world where procedural ontology drifts, and every appeal updates belief "
            "about what kind of system is judging you."
        ),
        motif=(
            "Ontological uncertainty in every chamber: categories mutate, authority remains ambiguous, and inference loops replace stable rules."
        ),
    )
    ...
    out_path = out_dir / "kafka_the_trial_ontological_uncertainty_multiending_v1.json"
    ...
    gate_path = report_dir / "kafka_the_trial_ontological_uncertainty_multiending_v1.gate.json"
    ...
    summary_path = report_dir / "kafka_the_trial_ontological_uncertainty_multiending_v1.summary.json"
